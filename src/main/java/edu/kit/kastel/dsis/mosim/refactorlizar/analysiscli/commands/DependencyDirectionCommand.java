...
public class DependencyDirectionCommand {
  private static final String STARTING_DEPENDENCY_CYCLE_ANALYSIS = "Starting dependency direction Analysis";
  private static final Logger logger = LogManager.getLogger(MethodHandles.lookup().lookupClass());

  @ShellMethod("Find occurrences of the dependency direction smells on type level. Layers must be ordered from bottom to top and separated by ','")
  ...
  @ShellMethod("Find occurrences of the dependency direction smells on package level. Layers must be ordered from bottom to top and separated by ','")
  ...
  @ShellMethod("Find occurrences of the dependency direction smells on component level. Layers must be ordered from bottom to top and separated by ','")
